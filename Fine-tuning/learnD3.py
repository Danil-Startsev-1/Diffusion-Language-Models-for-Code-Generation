...
D3_PATH = TOKENROOT / "B_raw" / "D3" / "train.parquet"

OUTPUT_ROOT = "/home/dstartsev/checkpoint/D3"
RUN_NAME = "stable-diffcoder_D3_1epoch"
...
def main():
    ...
    print("=" * 80, flush=True)
    print("Starting Stable-DiffCoder LoRA fine-tuning on D3", flush=True)
    print(f"Model path: {MODEL_PATH}", flush=True)
    print(f"Dataset path: {D3_PATH}", flush=True)

...
ADAPTER_FINAL_DIR = "/home/dstartsev/checkpoint/D4/stable-diffcoder_D4_1epoch/final_adapter"

SAVE_DIR = Path("/home/dstartsev/checkpoint/D4/test")
...
def load_stable_model_with_adapter():
    ...
    model.eval()
    print("LoRA-adapted Stable-DiffCoder D4 loaded from", ADAPTER_FINAL_DIR)

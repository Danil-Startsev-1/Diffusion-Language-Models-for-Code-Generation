...
ADAPTER_FINAL_DIR = "/home/dstartsev/checkpoint/D2/stable-diffcoder_D2_1epoch/final_adapter"

SAVE_DIR = Path("/home/dstartsev/checkpoint/D2/test")
...
def load_stable_model_with_adapter():
    ...
    model.eval()
    print("LoRA-adapted Stable-DiffCoder D2 loaded from", ADAPTER_FINAL_DIR)
